...
def human_readable_map():
    hr_map = {
        ...
        'TotalNumberOfWords': 'Number of Words per Utterance ',
        'NP_to_DT_NN': 'Noun Phrase to Determiner, Noun',
        'NP_to_PRP': 'Noun Phrase to Personal Pronoun',
        ...
        'ls_count': 'Attention: Leftside',
        'ls_kw_to_w_ratio': 'Concentration: Leftside',
        'ls_ty_to_tok_ratio': 'Repetition: Leftside',
        'prcnt_ls_uttered': 'Perception: Leftside',
        'rs_count': 'Attention: Rightside',
        'rs_kw_to_w_ratio': 'Concentration: Rightside',
        'rs_ty_to_tok_ratio': 'Repetition: Rightside',
        'prcnt_rs_uttered': 'Perception: Rightside',
